...
void main() {
  runApp(const MyChatApp(title: 'Chat with Player',));
}
...
class MyChatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChatWithPlayer(title: 'Flutter Demo Home Page'),
    );
  }
}

class ChatWithPlayer extends StatefulWidget {
  const ChatWithPlayer({super.key, required this.title});

  final String title;

  @override
  State<ChatWithPlayer> createState() => _ChatWithPlayerState();
}
...
class _ChatWithPlayerState extends State<ChatWithPlayer> {
  int _counter = 0;
  String name = "";

  _ChatWithPlayerState() {
