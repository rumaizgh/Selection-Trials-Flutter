...
class MyChatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChatWithCoach(title: 'Flutter Demo Home Page'),
    );
  }
}

class ChatWithCoach extends StatefulWidget {
  const ChatWithCoach({super.key, required this.title});

  final String title;

  @override
  State<ChatWithCoach> createState() => _ChatWithCoachState();
}
