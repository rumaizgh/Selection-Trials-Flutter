...
void main() {
  runApp(const MyChatApp(title: 'Chat with Academy',));
}

class MyChatApp extends StatelessWidget {
  const MyChatApp({super.key, required String title});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChatWithAcademy(title: 'Flutter Demo Home Page'),
    );
  }
}

class ChatWithAcademy extends StatefulWidget {
  const ChatWithAcademy({super.key, required this.title});

  final String title;

  @override
  State<ChatWithAcademy> createState() => _ChatWithAcademyState();
}
...
class _ChatWithAcademyState extends State<ChatWithAcademy> {
  int _counter = 0;
  String name = "";

  _ChatWithAcademyState() {
