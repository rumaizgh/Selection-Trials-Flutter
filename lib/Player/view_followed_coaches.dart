...
void main() {
  runApp(const ViewFollowedCoach(title: '',));
}

class ViewFollowedCoach extends StatelessWidget {
  const ViewFollowedCoach({super.key, req, required String title});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewFollowedCoachPage(title: 'View Reply'),
    );
  }
}

class ViewFollowedCoachPage extends StatefulWidget {
  const ViewFollowedCoachPage({super.key, required this.title});

  final String title;

  @override
  State<ViewFollowedCoachPage> createState() => _ViewFollowedCoachPageState();
}

class _ViewFollowedCoachPageState extends State<ViewFollowedCoachPage> {

  _ViewFollowedCoachPageState(){
    ViewFollowedCoach();
  }
  ...
  Future<void> ViewFollowedCoach() async {
    ...
    try {
      ...
      String url = '$urls/ply_view_followed_coach/';
